...
# install postres
sudo apt-get -q -y install postgresql-9.3 
sudo apt-get -q -y install postgresql-9.3-postgis
sudo apt-get -q -y install pgadmin3
sudo apt-get -q -y install postgresql-contrib
